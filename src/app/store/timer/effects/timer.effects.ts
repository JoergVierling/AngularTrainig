...
import {loadTimers, setTime, startTime, stopTime} from '../actions/timer.actions';
...
export class TimerEffects {
  constructor(private actions: Actions, private store$: Store<fromRoot.State>, private timerService: TimerService) {
  }
